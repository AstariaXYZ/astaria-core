...
contract AstariaRouter is Auth, Pausable, IAstariaRouter {
    ...
    function validateCommitment(
        ...
        address borrower
    ) public returns (bool valid, IAstariaRouter.LienDetails memory ld) {
        require(
     ...
     */
    function newVault(address delegate)
        external
        whenNotPaused
        returns (address)
    {
     ...
     */
    function newPublicVault(uint256 epochLength, address delegate)
        external
        whenNotPaused
        returns (address)
    {
     ...
     */
    function getStrategistFee(uint256 amountIn)
        external
        view
        returns (uint256)
    {
     ...
     */
    function _newVault(uint256 epochLength, address delegate)
        internal
        returns (address)
    {
        uint256 brokerType;
